...
function LoginForm() {
  ...
  async function handleEmailSignIn(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setLocalError(msg.includes("invalid-credential") ? "Invalid email or password" : msg);
      setLoading(false);
    }
  }
  ...
  return (
    <div className="w-full max-w-sm">
      <div className="mb-8 text-center">
        ...
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Sign in to your HireLens AI account</p>
      </div>
      ...
      <form onSubmit={handleEmailSignIn} className="space-y-4">
        ...
        <div>
          <div className="mb-1 flex items-center justify-between">
            ...
            <Link href="/forgot-password" className="text-xs text-brand-600 hover:text-brand-700 dark:text-brand-400">Forgot password?</Link>
          </div>
      ...
      <p className="mt-6 text-center text-sm text-slate-500 dark:text-slate-400">
        ...
        <Link href="/signup" className="font-medium text-brand-600 hover:text-brand-700 dark:text-brand-400">Create account</Link>
      </p>
    </div>
  );
}
